...
function calculatePasswordStrength(password) {
    ...
    if (score <= 2) {
        return { class: 'weak', text: 'Слабый', color: '#ef4444' };
    } else if (score <= 3) {
        return { class: 'fair', text: 'Средний', color: '#f59e0b' };
    } else if (score <= 4) {
        return { class: 'good', text: 'Хороший', color: '#10b981' };
    } else {
        return { class: 'strong', text: 'Надёжный', color: '#2563eb' };
    }
}
